...
-   analyse task complexity with `analyse_project_complexity` / `task-master analyse-complexity --research` (see [`taskmaster.md`](mdc:.roo/rules/taskmaster.md)) before breaking down tasks
...
-   Run `analyse_project_complexity` / `task-master analyse-complexity --research` (see [`taskmaster.md`](mdc:.roo/rules/taskmaster.md)) for comprehensive analysis
