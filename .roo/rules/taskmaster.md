...
**Important:** Several MCP tools involve AI processing... The AI-powered tools include `parse_prd`, `analyse_project_complexity`, `update_subtask`, `update_task`, `update`, `expand_all`, `expand_task`, and `add_task`.
...
### 21. analyse Project Complexity (`analyse_project_complexity`)

*   **MCP Tool:** `analyse_project_complexity`
*   **CLI Command:** `task-master analyse-complexity [options]`
*   **Description:** `Have Taskmaster analyse your tasks to determine their complexity and suggest which ones need to be broken down further.`
*   **Key Parameters/Options:**
...
*   **Usage:** Review and understand the complexity analysis results after running analyse-complexity.
