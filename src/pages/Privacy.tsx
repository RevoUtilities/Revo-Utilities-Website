...
const Privacy = () => {
  return (
    <>
      <SEOHead 
        title="Privacy Policy - Revo Utilities"
        description="Learn how Revo Utilities collects, uses, and protects your personal information in accordance with UK data protection laws."
        url="https://www.revo-utilities.com/privacy"
      />
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Important notice</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Personal Data we may collect and why</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">What cookies are used on this Site?</h3>
                <p className="text-gray-700 mb-4">
                ...
                <ul className="list-disc pl-6 text-gray-700 mb-4">
                  <li>Internet Advertising Bureau website at <a href="http://www.youronlinechoices.com/" className="text-blue-600 hover:text-blue-800">http://www.youronlinechoices.com/</a> where you will be able to opt-out of receiving Interest-Based Advertising cookies from some of the third parties listed below; and/or</li>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. How we use your personal data</h2>
                <p className="text-gray-700 mb-4">
                  We use your personal data for the following purposes:
                </p>
                
                <h3 className="text-xl font-medium text-gray-900 mb-3">To provide you with the products and services you have requested</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To send you service communications, including in relation to changes to our Trading Terms or Terms of Trading</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">Direct marketing (including by third parties)</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To track your usage of our website, communications, products and services</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To provide and improve customer support</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To maintain our records and improve data accuracy</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To respond to enquiries, complaints and disputes</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">To investigate, detect and prevent fraud and comply with our legal obligations</h3>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Legal grounds for processing</h2>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">Necessary for the performance of a contract and to comply with our legal obligations</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">Necessary for the purposes of our legitimate business interests or those of a third party</h3>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Who we share your personal data with</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. How long we keep your personal data for</h2>
                <p className="text-gray-700 mb-4">
                  ...
                  <table className="min-w-full border border-gray-300">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-4 py-2 text-left font-semibold">Rights</th>
                        <th className="border border-gray-300 px-4 py-2 text-left font-semibold">What does this mean?</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">1. Rights to be informed</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to be provided with clear, transparent and easily understandable information about how we use your personal data and your rights. This is why we are providing you with the information in this Privacy Policy.</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-gray-300 px-4 py-2">2. Right of access</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to obtain access to your personal data (if we are processing it) and certain other information (similar to that provided in this Privacy Policy). This is so you are aware and can check that we are using your personal data in accordance with data protection law.</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">3. Right to rectification</td>
                        <td className="border border-gray-300 px-4 py-2">You are entitled to have your personal data corrected if it is inaccurate or incomplete.</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-gray-300 px-4 py-2">4. Right to erasure</td>
                        <td className="border border-gray-300 px-4 py-2">This is also known as &apos;the right to be forgotten&apos; and, in simple terms, enable you to request the deletion or removal of your personal data where there is no compelling reason for us to keep using it. This is not a general right to erasure; there are exceptions.</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">5. Right to restrict processing</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to &apos;block&apos; or supress further use of your personal data in certain circumstances. When processing is restricted, we can still store your personal data, but may not use it further.</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-gray-300 px-4 py-2">6. Right of data portability</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to obtain and reuse your personal data in a structured, commonly used and machine-readable format in certain circumstances. In addition, where certain conditions apply, you have the right to have such information transferred directly to a third party.</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">7. Right to object to processing</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to object to us processing your personal data for our legitimate business interests or for direct marketing purposes (including in each case any related profiling).</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-gray-300 px-4 py-2">8. Right to withdraw consent to processing</td>
                        <td className="border border-gray-300 px-4 py-2">If you have given your consent to us to process your personal data for a particular purpose (for example, direct marketing), you have the right to withdraw your consent at any time (although if you do so, it does not mean that any processing of your personal data up to that point is unlawful).</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-2">9. Right to make a complaint to the data protection authorities</td>
                        <td className="border border-gray-300 px-4 py-2">You have the right to make a complaint to the Information Commissioner&apos;s Office (ICO) if you are unhappy with how we have handled your personal data or believe our processing of your personal data does not comply with data protection law.</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-700 mb-4">
                  <li>writing to: Information Commissioner&apos;s Officer, Wycliffe House, Water Lane, Wilmslow, Cheshire, SK9 5AF;</li>
                  <li>calling: 0303 123 1113; or</li>
                  <li>submitting a message through the ICO&apos;s website at: <a href="https://ico.org.uk" className="text-blue-600 hover:text-blue-800">ico.org.uk</a></li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Links to other websites</h2>
                <p className="text-gray-700 mb-4">
